			...
			<table border="0" width="100%">
				...
				<tr>
					...
					<?php
						...
						echo form_input(array('name'=>'txt_con_kh_first_name','placeholder'=>'គោត្តនាម'));
					?>
					</td>
					<td>
					<?php 
						echo form_label('Sure Name in Khmer <span>*</span>','lbl_con_kh_last_name');
						echo form_input(array('name'=>'txt_con_kh_last_name','placeholder'=>'នាម'));
					?>
					</td>
					<td>
					<?php 
