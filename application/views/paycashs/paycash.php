...
open_form('payer_details', "Payer Details");
...
field("text", "gl_code", "GL Code: ", NULL, array('attribute' => array('list' => "list_gl_code", 'id' => "gl_code", 'style' => "width:209px;"))
...
close_form();
open_form('transaction_info', 'Transaction Information');
