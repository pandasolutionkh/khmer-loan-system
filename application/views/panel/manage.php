...
<div class="panel-control">
    <div class="row">
        ...
        <div class="span"> <a class="row" href="<?php echo site_url('saving/open'); ?>"><img title="New Loan" alt="New Saing Account" src="<?php echo site_url(IMAGES_PATH_BOOTSTRAP . 'contact.png'); ?>"> <span class="row">New Saving</span></a> </div>
        ...
        <div class="span"> <a class="row" href="<?php echo site_url('journals/journal#form_journal'); ?>"><img title="Journals Entry" alt="Journals Entry" src="<?php echo site_url(IMAGES_PATH_BOOTSTRAP . 'contact.png'); ?>"> <span class="row">Journals Entry</span></a> </div>
        ...
        <div class="span"> 
            <a class="row" href="<?php echo base_url(); ?>loan/repayment">
                <img title="Contacts" alt="repayment" src="<?php echo site_url(IMAGES_PATH_BOOTSTRAP . 'payment.png'); ?>"> 
                <span class="row">Loan Repayment</span></a> </div>
        <div class="span"> 
            <a class="row" href="<?php echo base_url(); ?>deposits">
                <img title="Contacts" alt="deposits" src="<?php echo site_url(IMAGES_PATH_BOOTSTRAP . 'payment.png'); ?>"> 
                <span class="row">Deposits</span></a> </div>
                
        <div class="span"> 
            <a class="row" href="<?php echo base_url(); ?>withdrawals">
                <img title="Contacts" alt="withdrawals" src="<?php echo site_url(IMAGES_PATH_BOOTSTRAP . 'payment.png'); ?>"> 
