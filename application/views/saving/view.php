...
<div class="row form-container">
    ...
    <div class="span12">
        <div class="tools">
            ...
            <a disabled="disabled" class="btn btn-mini btn-success" href="<?php echo base_url() . 'saving/view'; ?>" title="View saving account"><i class="icon-eye-open icon-white"></i> View new saving account</a>
